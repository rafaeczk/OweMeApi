...
public class GetFriendRequestsListHandler(AppDbContext context)
    : IRequestHandler<GetFriendRequestsListQuery, Result<List<FriendRequestDTO>>>
{
    public async Task<Result<List<FriendRequestDTO>>> Handle(GetFriendRequestsListQuery request, CancellationToken ct)
    {
